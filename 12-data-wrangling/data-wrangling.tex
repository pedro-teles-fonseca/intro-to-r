...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{subset}\NormalTok{(df, inc }\OperatorTok{>=}\StringTok{ }\DecValTok{2} \OperatorTok{&}\StringTok{ }\NormalTok{state }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"MA"}\NormalTok{, }\StringTok{"FL"}\NormalTok{, }\StringTok{"CA"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
