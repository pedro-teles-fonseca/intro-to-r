...
- There are packages that allow import xls and xlsx tables into R, but if you want to read data from excel I reccomend saving your excel worksheet as a CSV or text (tab delimited) file instead.
...
Read the mtcars0.csv file from the datasets folder and assign it to an objet:
...
- The `na` arguments indictes how the `NA` values should be displayed in the output file
